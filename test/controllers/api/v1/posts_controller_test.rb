...
class Api::V1::PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_post" do
    assert_difference("Api::V1::Post.count") do
      post api_v1_posts_url, params: { api_v1_post: { content: @api_v1_post.content, text: @api_v1_post.text, title: @api_v1_post.title } }, as: :json
    end
  ...
  test "should update api_v1_post" do
    patch api_v1_post_url(@api_v1_post), params: { api_v1_post: { content: @api_v1_post.content, text: @api_v1_post.text, title: @api_v1_post.title } }, as: :json
    assert_response :success
  end
